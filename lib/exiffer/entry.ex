defmodule Exiffer.Entry do
  ...
  @entry_info %{
    ...
    gps_latitude: %{type: :gps_latitude, magic: <<0x00, 0x02>>, formats: [:rational_64u, :rational_64s], name: "GPSLatitude", label: "GPS Latitude"},
    gps_longitude_ref: %{type: :gps_longitude_ref, magic: <<0x00, 0x03>>, formats: [:string], name: "GPSLongitudeRef", label: "GPS Longitude Ref"},
    gps_longitude: %{type: :gps_longitude, magic: <<0x00, 0x04>>, formats: [:rational_64u, :rational_64s], name: "GPSLongitude", label: "GPS Longitude"},
    ...
    gps_time_stamp: %{type: :gps_time_stamp, magic: <<0x00, 0x07>>, formats: [:rational_64u], name: "GPSTimeStamp", label: "GPS Time Stamp"},
    gps_date_stamp: %{type: :gps_date_stamp, magic: <<0x00, 0x1d>>, formats: [:string], name: "GPSDateStamp", label: "GPS Date Stamp"},
    ...
    image_description: %{type: :image_description, magic: <<0x01, 0x0e>>, formats: [:string], name: "ImageDescription", label: "Image Description"},
    ...
    tag_0x8895: %{type: :tag_0x8895, magic: <<0x88, 0x95>>, formats: [:int16u], name: "Tag0x8895", label: "Tag 0x8895"},
    ...
    light_source: %{type: :light_source, magic: <<0x92, 0x08>>, formats: [:int16u], name: "LightSource", label: "Light Source"},
    ...
    sub_sec_time: %{type: :sub_sec_time, magic: <<0x92, 0x90>>, formats: [:string], name: "SubSecTime", label: "Sub Sec Time"},
    tag_0x9999: %{type: :tag_0x9999, magic: <<0x99, 0x99>>, formats: [:string], name: "Tag0x9999", label: "Tag0x9999"},
    ...
    exif_white_balance: %{type: :exif_white_balance, magic: <<0xa4, 0x03>>, formats: [:int16u], name: "EXIFWhiteBalance", label: "EXIF White Balance"},
    ...
    sharpness_2: %{type: :sharpness_2, magic: <<0xa4, 0x0a>>, formats: [:int16u], name: "EXIFSharpness", label: "EXIF Sharpness"},
