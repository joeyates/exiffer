defmodule Exiffer.Entry do
  ...
  @entry_info %{
    ...
    image_width: %{type: :image_width, magic: <<0x01, 0x00>>, formats: [:int32u], label: "Image Width"},
    image_height: %{type: :image_height, magic: <<0x01, 0x01>>, formats: [:int32u], label: "Image Height"},
    ...
    orientation: %{type: :orientation, magic: <<0x01, 0x12>>, formats: [:int16u], label: "Orientation"},
    ...
    exif_version: %{type: :exif_version, magic: <<0x90, 0x00>>, formats: [:raw_bytes], label: "Exif Version"},
    ...
    exif_image_height: %{type: :exif_image_height, magic: <<0xa0, 0x03>>, formats: [:int16u, :int32u], label: "Exif Image Height"},
